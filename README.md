...
SharkBuster‑web is a modular web discovery toolkit that includes multiple built‑in tools such as SharkBuster‑web and SharkScan‑web, accessible through a single launcher.
